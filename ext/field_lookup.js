...
goog.inherits(FieldLookup, Blockly.Field);
FieldLookup.prototype.init = function () {
    if (this._container) {
 ...
 * @private
 */
FieldLookup.prototype.render_ = function() {
  if (!this.visible_) {
    this.size_.width = 0;
    return;
  }
...
FieldLookup.prototype._onMouseDown = function (e) {
...
FieldLookup.prototype.getSvgRoot = function () {
    return this._container;
};
FieldLookup.prototype.showEditor_ = function () {
...
FieldLookup.prototype.focus = function () {
    let onKeyDown = (e) => {
...
window.Blockly['FieldLookup'] = FieldLookup;
